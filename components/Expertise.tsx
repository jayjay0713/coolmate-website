...
export default function Expertise() {
  return (
    <section
      id="about"
      className="scroll-mt-24 border-t border-[#25282D] bg-[#101214] py-16 lg:scroll-mt-32 lg:py-24"
    >
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-base leading-7 text-[#94A3B8] lg:mt-6 lg:text-lg lg:leading-8">
            Coolmate Maintenance & Solutions Co. provides expert preventive
            maintenance, troubleshooting, and repair services for VRF and
            split-type air conditioning systems. We deliver dependable HVAC
            solutions that maximize system performance, minimize downtime,
            and ensure efficient operation across residential, commercial,
            ...
            return (
              <div
                ...
                className="
                  ...
                  hover:bg-[#1A1D21]
                  hover:shadow-[0_15px_50px_rgba(22,131,255,0.12)]
                  lg:p-10
                "
              >
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-[#F8FAFC] lg:text-2xl">
                  {item.title}
                </h3>

                {/* Description */}
                <p className="mt-4 leading-7 text-[#94A3B8] lg:mt-5 lg:leading-8">
                  {item.description}
                </p>
